...
function makeEnemies() {
  return [
    ...
    new Enemy("Hexagon", 60, ["defend", "attack", "debuff", "attack"], [92, 66, 99], 6, 4, 2),
    new Enemy("Sphere", 100, ["wall", "attack", "attack", "debuff", "attack", "charge", "attack", "heal"], [135, 23, 23], 0, 5, 3),
  ];
}